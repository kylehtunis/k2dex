...
8. **`notebooks/energy_discrimination.ipynb`** — standalone. Real-vs-null team scoring, Score decomposition (popularity vs. coherence), and `field_weight` AUC sweep (optimal ~0.25-0.30). Chronological 90/10 split.
